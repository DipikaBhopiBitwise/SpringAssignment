...
private	List<ProductDetailsClass> productlist =new ArrayList<ProductDetailsClass>();
	...
	private void addProducts() 
	{
		...
		productlist.add(new ProductDetailsClass("Shirt","42","Blue","2000","3"));
		productlist.add(new ProductDetailsClass("Pants","32","Black","3500","4"));
		productlist.add(new ProductDetailsClass("Saree","3 meters","Orange","10000","5"));
	}
